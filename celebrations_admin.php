...
<?php $page_title = 'Project ABCD > celebrations_tbl'; ?>
...
<div class="container-fluid">
    ...
    <h2 id="title">Celebration Management</h2><br>
    
    <div id="customerTableView">
        <button><a class="btn btn-sm" href="create_celebration.php">Create New Celebration</a></button>
            ...
            <div class="table responsive">
                ...
                if ($data->num_rows > 0) {
                    ...
                    while($row = $data->fetch_assoc()) {
                        echo '<tr>
                                <td>'.$row["id"].'</td>
                                <td> </span> <a href="display_the_user.php?id='.$row["id"].'">'.$row["title"].'</a></td>
